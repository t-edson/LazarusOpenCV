...
begin
  ...
  if capture=nil then begin
     Application.MessageBox('Cannot capture from WebCam','');
     halt(1);
  end;
...
procedure TForm1.DetectingRedObjects(img: pIplImage);
Var
  imgHSV: pIplImage;
  imgThresh: pIplImage;
  frame: pIplImage;
begin
  ...
  ipDraw(pb1.Canvas, frame, pb1.ClientRect);

  ipDraw(pb2.Canvas, imgThresh, pb1.ClientRect);
...
procedure TForm1.TrackingRedObjects(img: pIplImage);
Var
  imgHSV: pIplImage;
  imgThresh: pIplImage;
  frame: pIplImage;
...
procedure TForm1.trackObject(imgThresh: pIplImage);
Var
  moments: pCvMoments;
